      ...
      <ul class="app-menu">
        ...
        <li class="treeview">
            <a class="app-menu__item" href="#" data-toggle="treeview">
                ...
                <span class="app-menu__label">Detalles Docentes</span>
                <i class="treeview-indicator fa fa-angle-right"></i>
            </a>
            <ul class="treeview-menu">
                <?php if(!empty($_SESSION['permisos'][4]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/productos"><i class="icon fa fa-circle-o"></i> Horario</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/justificacion"><i class="icon fa fa-circle-o"></i> T. Justificaciones</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/aulas"><i class="icon fa fa-circle-o"></i> Aulas</a></li>
                <?php } ?>
            </ul>
        </li>
        <?php } ?>
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>/suscriptores">
                ...
                <span class="app-menu__label">T. Contrato</span>
            </a>
        </li>
         <?php } ?>
