<?php headerAdmin($data); ?>
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/docentes" class="linkw">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-user fa-3x"></i>
              <div class="info">
                <h4>Docentes</h4>
                <p><b><?= $data['docentes'] ?></b></p>
              </div>
            </div>
          </a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Asistencias</h3>
        ...
        <div class="col-md-6">
          <div class="tile">
            <div class="container-title">
              <h3 class="tile-title">Últimas Faltas</h3>
              <table class="table table-striped table-sm">
              <thead>
                <tr>
                  <th>#</th>
