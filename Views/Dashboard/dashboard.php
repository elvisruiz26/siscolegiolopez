<?php headerAdmin($data); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="container-title">
                    <h3 class="tile-title">Reporte de Asistencias del Mes</h3>
                    <div class="dflex">
                        <input class="date-picker asistenciaMes" name="asistenciaMes" placeholder="Mes y Año">
                        <button type="button" class="btnAsistenciasMes btn btn-info btn-sm" onclick="fntSearchAsistencias()"> <i class="fas fa-search"></i> </button>
                    </div>
                </div>
                <div id="reporteAsistenciasMes"></div>
            </div>
        </div>
    </div>
    <!-- Contenido existente -->
    ...
    <div class="col-md-6">
        <div class="tile">
            <h3 class="tile-title">Reporte Mensual de Asistencias</h3>
            <div class="tile-body">
                <form id="formReporteMes">
                    ...
                    <div class="form-group">
                        <label for="anioMes">Año:</label>
                        <input type="number" id="anioMes" name="anio" class="form-control" value="<?= date('Y'); ?>">
                    </div>
                    <button type="button" class="btn btn-primary" onclick="generarReporteMes();">Generar Reporte</button>
                </form>
                <div id="reporteMensual"></div>
                <button type="button" class="btn btn-secondary" onclick="descargarReporte('mensual');">Descargar Reporte</button>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="tile">
            <h3 class="tile-title">Reporte Anual de Asistencias</h3>
            <div class="tile-body">
                <form id="formReporteAnio">
                    <div class="form-group">
                        <label for="anioAnual">Año:</label>
                        <input type="number" id="anioAnual" name="anio" class="form-control" value="<?= date('Y'); ?>">
                    </div>
                    <button type="button" class="btn btn-primary" onclick="generarReporteAnual();">Generar Reporte</button>
                </form>
                <div id="reporteAnual"></div>
                <button type="button" class="btn btn-secondary" onclick="descargarReporte('anual');">Descargar Reporte</button>
            </div>
        </div>
    </div>
