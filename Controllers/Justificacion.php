<?php
	class Justificacion extends Controllers{
		...
		public function Justificacion()
		{
			...
			$data['page_tag'] = "Tipo Justificaciones";
			$data['page_title'] = "TIPO JUSTIFICACIONES <small>I.E Lopez Albujar</small>";
			$data['page_name'] = "categorias";
			$data['page_functions_js'] = "functions_categorias.js";
			$this->views->getView($this,"justificacion",$data);
		}
